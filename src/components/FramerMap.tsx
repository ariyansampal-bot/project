// FramerEmbedFixed.tsx
import React from "react";

const FramerEmbedFixed: React.FC = () => {
  return (
    <div
      // 1) your exact HTML (unchanged)
      dangerouslySetInnerHTML={{
        __html: `
<!-- ========== BEGIN: EXACT HTML YOU PROVIDED (UNCHANGED) ========== -->
<div id="__framer-exact-root">
  <style>
  ...
  <div id="main" data-framer-hydrate-v2='{"routeId":"nhXAaxVjg","localeId":"default","breakpoints":[{"hash":"1vw04pd","mediaQuery":"(min-width: 1200px)"},{"hash":"6pfjti","mediaQuery":"(min-width: 810px) and (max-width: 1199px)"},{"hash":"bb9v7y","mediaQuery":"(max-width: 809px)"}]}' data-framer-ssr-released-at="2025-08-26T12:46:46.255Z" data-framer-page-optimized-at="2025-08-29T08:42:49.763Z" data-framer-generated-page="">
...
</div><!-- /#__framer-exact-root -->
<!-- ========== END: EXACT HTML YOU PROVIDED (UNCHANGED) ========== -->

<!-- ========== BEGIN: OVERRIDES TO FIX SPLIT/WHITE GAP/RESPONSIVE ========== -->
<style id="framer-fixes">
  /* --- Tunable sizes (adjust these 4 variables to taste) --- */
  #__framer-exact-root{
    --banner-h-desktop: 1353px;   /* overall banner height on large screens */
    --banner-h-mobile:  300px;   /* overall banner height on mobile */
    --strip-h-desktop: 1353px;   /* black SVG strip height (desktop) */
...
export default FramerEmbedFixed;
